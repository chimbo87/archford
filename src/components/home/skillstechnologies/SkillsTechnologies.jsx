      ...
      <div className="skills__container">
        ...
        <div className="skills__header">
          ...
          <h2 className="skills__title">
            Skills & <span className="skills__title-highlight">Technologies</span>
          </h2>
              ...
              >
                ...
                <div className="skills__item-header">
                  ...
                  <div className="skills__item-level">
                    ...
                    <span className="skills__level-percentage">{skill.level}%</span>
                  </div>
                </div>
                  ...
                  <div className="skills__progress-track">
                    <div
                      className={`skills__progress-fill ${
                        animatedSkills.has(`${activeCategory}-${skill.name}`) ? 'animated' : ''
                      }`}
                      style={{
