...
import banner from "../../../assets/images/wallpaper02.png";
import './Hero.css';
        ...
        <div className="hero__content">
          ...
          <div className="hero__text">
            <div className="hero__greeting">
              <span className="hero__greeting-icon">👋</span>
              <span className="hero__greeting-text">Hello, I'm</span>
            </div>
            
            <h1 className="hero__name">
              <span className="hero__name-highlight">Archford</span> Nhanga
            </h1>
            
            <div className="hero__role">
              <span className="hero__role-text">I'm a </span>
            ...
            <p className="hero__description">
              ...
              I transform ideas into powerful web applications.
            </p>
            ...
            <div className="hero__tech-stack">
              ...
              <div className="hero__tech-icons">
                <div className="hero__tech-icon" title="React">
                  <svg width="24" height="24" fill="#61DAFB" viewBox="0 0 24 24">
                ...
                <div className="hero__tech-icon" title="JavaScript">
                  <svg width="24" height="24" fill="#F7DF1E" viewBox="0 0 24 24">
                ...
                <div className="hero__tech-icon" title="Node.js">
                  <svg width="24" height="24" fill="#339933" viewBox="0 0 24 24">
                ...
                <div className="hero__tech-icon" title="Python">
                  <svg width="24" height="24" fill="#3776AB" viewBox="0 0 24 24">
