        ...
        <div className="footer__content">
          ...
          <div className="footer__brand">
            <div className="footer__logo">
              <span className="footer__logo-text">DevPortfolio</span>
            </div>
          ...
          <div className="footer__contact">
            ...
            <div className="footer__contact-info">
              <div className="footer__contact-item">
                ...
                <a href="mailto:your.email@example.com" className="footer__contact-value">
                  archfordnhanga@gmail.com
                </a>
              </div>
              <div className="footer__contact-item">
                <span className="footer__contact-label">Location:</span>
                <span className="footer__contact-value">Johannesburg, South Africa</span>
              </div>
              <div className="footer__contact-item">
                <span className="footer__contact-label">Status:</span>
                <span className="footer__contact-value footer__status">
